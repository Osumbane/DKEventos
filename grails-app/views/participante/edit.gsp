...
<html>
	...
	<body>
		<a href="#edit-participante" class="skip" tabindex="-1"><g:message code="default.link.skip.label" default="Skip to content&hellip;"/></a>
		...
		<div id="edit-participante" class="content scaffold-edit" role="main">
			...
			<g:form url="[resource:participanteInstance, action:'update']" method="PUT" >
